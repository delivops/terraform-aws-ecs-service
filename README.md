...
| <a name="input_ecs_desired_count"></a> [ecs_task_count](#input_ecs_task_count)                                                                | Desired number of tasks                   | `number`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `1`              |    no    |
...
| <a name="input_service_connect_enabled"></a> [service_connect_enabled](#input_service_connect_enabled)                                        | bool for service connect                  | `bool`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `false`          |    no    |
